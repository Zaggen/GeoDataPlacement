...
$(document).ready(function(){
            ...
            $.ajax({
                ...
                async: false
                    ...
                    if(data.status === 'OK'){
                        ...
                        console.assert(data.results[0].geometry.location !== 'undefined', 'There is a location in the data');
    ...
    google.maps.event.addListenerOnce(mapReach.map, 'tilesloaded', function(){
